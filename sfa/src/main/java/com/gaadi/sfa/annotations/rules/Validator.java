...
public class Validator {
    ...
    /**
     * Creates a new {@link com.gaadi.sfa.annotations.rules.Validator}.
     *
    ...
    public interface ValidationListener {
       ...
       * error was fixed.
       *
       * @param succeededView The {@link View} that was successfully validated.
       */
     ...
     *
     * @throws IllegalStateException If a {@link com.gaadi.sfa.annotations.rules.Validator.ValidationListener} is not registered.
     */
...
//        }
        ...
        if (mViewsAndRules.size() == 0) {
             Logger.e("No rules found. Passing validation by default.");
            return null;
        }
    ...
    private void createRulesFromAnnotations(List<AnnotationFieldPair> annotationFieldPairs) {
        ...
        for (AnnotationFieldPair pair : annotationFieldPairs) {
            ...
            if (viewRulePair != null) {
                if (DEBUG) {
                     Logger.d(TAG, String.format("Added @%s rule for %s.",
    ...
    private ViewRulePair getViewAndRule(Field field, Annotation annotation, Object... params) {
        ...
        if (view == null) {
             Logger.w(TAG, String.format("Your %s - %s is null. Please check your field assignment(s).",
