...
package com.gaadi.sfa.annotations.rules;
...
import com.gaadi.sfa.annotations.CardNumber;
import com.gaadi.sfa.annotations.Checked;
import com.gaadi.sfa.annotations.ConfirmPassword;
import com.gaadi.sfa.annotations.Email;
import com.gaadi.sfa.annotations.FirstCharValidation;
import com.gaadi.sfa.annotations.IpAddress;
import com.gaadi.sfa.annotations.MobileNumber;
import com.gaadi.sfa.annotations.NoContactNumber;
import com.gaadi.sfa.annotations.NotAllowedChars;
import com.gaadi.sfa.annotations.NumberRule;
import com.gaadi.sfa.annotations.Password;
import com.gaadi.sfa.annotations.PropertyFloor;
import com.gaadi.sfa.annotations.RadioGrp;
import com.gaadi.sfa.annotations.Regex;
import com.gaadi.sfa.annotations.Required;
import com.gaadi.sfa.annotations.RequiredName;
import com.gaadi.sfa.annotations.Select;
import com.gaadi.sfa.annotations.TextRule;
import com.gaadi.sfa.annotations.TotalFloor;
import com.gaadi.sfa.annotations.ValueChecker;
...
class AnnotationToRuleConverter {
    ...
    private static Rule<View> getNotAllowedCharsRule(Field field, View view, NotAllowedChars annotation) {
        if (!EditText.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_TEXT, field.getName(), EditText.class.getSimpleName()));
            return null;
        }
        Logger.e("not allowed chars rule called");
    ...
    private static Rule<View> getCardNumberRule(Field field, View view, CardNumber annotation) {
        ...
        Logger.e("Card number rule called");
    ...
    private static Rule<TextView> getRequiredRule(Field field, View view,
        ...
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_TEXT, field.getName(), Required.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<TextView> getRequiredNameRule(Field field, View view,
        ...
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_TEXT, field.getName(), RequiredName.class.getSimpleName()));
            return null;
        }
    ...
    private static Rule<View> getPropertyFloorRule(Field field, View view, PropertyFloor propFloorRule) {
        ...
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_TEXT, field.getName(), PropertyFloor.class.getSimpleName()));
        }
    ...
    private static Rule<View> getFirstCharRule(Field field, View view,
        ...
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_TEXT, field.getName(),
    ...
    private static Rule<TextView> getTotalFloorsRule(Field field,
        ...
        if (!TextView.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_TEXT, field.getName(), TotalFloor.class.getSimpleName()));
            return null;
        }
    ...
    private static <T extends View & Checkable> Rule<T> getCheckedRule(
        ...
        if (!Checkable.class.isAssignableFrom(view.getClass())) {
            Logger.w(TAG, String.format(WARN_CHECKABLE, field.getName(),
